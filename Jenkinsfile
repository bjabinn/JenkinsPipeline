pipeline {
  ...
  parameters {
    ...
    booleanParam ( defaultValue: false, description: 'Clean Activiti LOC2 database', name : 'CLEAN_ACTIVITY_LOC2_DATABASE')
    ...
    booleanParam ( defaultValue: false, description: 'Run activity LOC2 database migration', name : 'RUN_ACTIVITY_LOC2_MIGRATION')
